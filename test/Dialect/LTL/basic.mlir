...
// CHECK: ltl.delay {{%.+}}, 0 clock {{%.+}}, posedge : !ltl.sequence
// CHECK: ltl.delay {{%.+}}, 42, 1337 clock {{%.+}}, posedge : !ltl.sequence
ltl.delay %s, 0 : !ltl.sequence
ltl.delay %s, 42, 1337 : !ltl.sequence
ltl.delay %s, 0 clock %clk, posedge : !ltl.sequence
ltl.delay %s, 42, 1337 clock %clk, posedge : !ltl.sequence
