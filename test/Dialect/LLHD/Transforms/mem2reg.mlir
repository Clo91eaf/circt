...
hw.module @IncompleteDefinitionOnSubset(in %u: i42, in %bool: i1) {
  ...
  ^bb2:
    ...
    // CHECK-NEXT: llhd.drv %a, [[A]] after [[T]] if [[ACOND]]
    // CHECK-NEXT: llhd.halt
    llhd.halt
  }
}
...
// Check that additional blocks get inserted to accomodate drives when control
// flow diverges and reaching definitions cannot continue into all successors.
